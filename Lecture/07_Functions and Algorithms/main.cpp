...
int main() {
    ...
    // auto compareRating = [](const Course& c1, Course& c2) {
    ...
    // auto medin = courses[courses.size()/2];
    std::vector<Course> csCourse;
    std::copy_if(courses.begin(), courses.end(), csCourse.begin(), isDep);
